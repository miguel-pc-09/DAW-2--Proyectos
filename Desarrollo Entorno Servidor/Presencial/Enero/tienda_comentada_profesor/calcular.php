            ...
            <div class="contenedor-calculadora">
                <div class="tarjeta-formulario">
                    ...
                    */
                    ...
                    // Creo un array asociativo con el precio de cada producto.
                    // Se leería como: en precios, iphone vale 1000, roomba vale 500 y reloj vale 100.
                    $precios = [
                        'iphone' => 1000,
                        'roomba' => 500,
                        'reloj' => 100
                ...
                */
                ...
                // Compruebo si el formulario se ha enviado por POST.
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    // Recojo el nombre del cliente. Puede venir vacío.
                    $cliente = isset($_POST['cliente']) ? trim($_POST['cliente']) : '';

                    // Variable acumuladora del total.
                    $total = 0;

                    // Variable para saber si el cliente buscado aparece al menos una vez.
                    $encontrado = false;
                    ...
                    if (file_exists('pedidos.txt')) {
                        ...
                        // Si se abre bien, lo recorro entero.
                        if ($archivo) {
                            while (!feof($archivo)) {
                                $linea = trim(fgets($archivo));

                                // Solo proceso líneas no vacías.
                                if ($linea != '') {
                                    // Divido la línea usando | como separador.
                                    $datos = explode('|', $linea);

                                    // Me aseguro de que haya 5 campos.
                                    if (count($datos) == 5) {
                                        $nombrePedido = $datos[0];
                                        $producto = $datos[2];
                                        $cantidad = (int) $datos[3];

                                        // Si el cliente está vacío, calculo todos.
                                        // Si no está vacío, solo sumo si coincide el nombre.
                                        if ($cliente == '' || $nombrePedido == $cliente) {
                                            // Marco encontrado si estamos buscando a un cliente concreto.
                                            if ($cliente != '') {
                                                $encontrado = true;
                                            }

                                            // Si el producto existe en el array de precios, sumo cantidad por precio.
                    ...
                    // Decido qué mensaje mostrar.
                    if ($cliente != '' && !$encontrado) {
                        $resultado = "Error. No se encuentra el cliente '$cliente'";
                    } elseif ($cliente == '') {
                        $resultado = "Total general de todos los pedidos: " . $total . "€";
                    } else {
                        $resultado = "Total del cliente $cliente: " . $total . "€";
                    }
                }
                ...
                <div class="tarjeta-resultado">
                    ...
                    <div class="resultado">
                        <div class="resultado-item">
                            <span class="valor destacado"><?php echo htmlspecialchars($resultado); ?></span>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
