    ...
    <div class="contenedor-pedido">
        <header class="cabecera">
            ...
            <nav class="navegacion">
                <a href="login.html" class="btn btn-secundario">Volver al login</a>
        ...
        <main class="principal">
            <div class="tarjeta-pedido">
                ...
                <!--
                    Este formulario manda los datos a guardar_pedido.php.
                    Se leería así:
                    - action="guardar_pedido.php" -> envía el formulario a guardar_pedido.php
                    - method="post" -> manda los datos por POST
                -->
