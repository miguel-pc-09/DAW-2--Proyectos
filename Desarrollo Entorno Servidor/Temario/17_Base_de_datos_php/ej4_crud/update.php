    ...
    <form method="post" action="">
        ...
        <table>
            <tr>
                ...
                <td><input type="text" name="nombre" value="<?php echo htmlspecialchars($producto['nombre']); ?>"
                        required></td>
            </tr>
            <tr>
                <td><label for="precio">Precio:</label></td>
                <td><input type="number" name="precio" step="0.01" value="<?php echo $producto['precio']; ?>" required>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <select name="categoria">
                        <option value="Electrónica"
                            <?php echo $producto['categoria'] == 'Electrónica' ? 'selected' : ''; ?>>Electrónica
                        </option>
                        <option value="Muebles" <?php echo $producto['categoria'] == 'Muebles' ? 'selected' : ''; ?>>
                            Muebles</option>
                        <option value="Libros" <?php echo $producto['categoria'] == 'Libros' ? 'selected' : ''; ?>>
                            Libros</option>
                        <option value="Accesorios"
                            <?php echo $producto['categoria'] == 'Accesorios' ? 'selected' : ''; ?>>Accesorios</option>
                        <option value="Ropa" <?php echo $producto['categoria'] == 'Ropa' ? 'selected' : ''; ?>>Ropa
                        </option>
                        <option value="Otros" <?php echo $producto['categoria'] == 'Otros' ? 'selected' : ''; ?>>Otros
                        </option>
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td><input type="date" name="fecha_creacion" value="<?php echo $producto['fecha_creacion']; ?>"
                        required></td>
            </tr>
            <tr>
                <td><label for="activo">Activo:</label></td>
                <td><input type="checkbox" name="activo" value="1" <?php echo $producto['activo'] ? 'checked' : ''; ?>>
                </td>
            </tr>
            <tr>
                <td colspan="2">
